...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http.csrf().disable()
                ...
                .requestMatchers("/api/v1/update-provider-info/{info}").hasAnyAuthority("ADMIN","PROVIDER")
                .requestMatchers("/api/v1/get-orders").hasAnyAuthority("ADMIN","PROVIDER")
                .requestMatchers("/api/v1/get-offers").hasAnyAuthority("ADMIN","PROVIDER")
                .requestMatchers("/api/v1/send-final/{offerId}").hasAnyAuthority("ADMIN","PROVIDER")
